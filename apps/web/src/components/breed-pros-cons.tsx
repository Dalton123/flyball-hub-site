    ...
    <div className={cn("grid gap-6 md:grid-cols-2", className)}>
      {pros && pros.length > 0 && (
        <div className="rounded-xl border border-green-200 bg-green-50/50 p-4">
          <h2 className="flex items-center gap-2 text-lg font-semibold text-green-800 mb-3">
      ...
      {cons && cons.length > 0 && (
        <div className="rounded-xl border border-red-200 bg-red-50/50 p-4">
          <h2 className="flex items-center gap-2 text-lg font-semibold text-red-800 mb-3">
