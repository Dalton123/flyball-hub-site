      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="relative bg-gradient-to-br from-primary to-primary/80 py-16 md:py-20 lg:py-24 rounded-3xl px-6 md:px-8 overflow-hidden">
          ...
          >
            ...
            <div className="text-base md:text-lg text-primary-foreground/80 max-w-2xl mx-auto">
              <RichText richText={richText} className="text-balance" />
            </div>
            <div className="flex justify-center pt-2">
              <SanityButtons
                buttons={buttons}
                buttonClassName="w-full sm:w-auto bg-background text-foreground hover:bg-background/90"
