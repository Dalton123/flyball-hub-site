...
function Lid({
  ...
  screenImage?: MacbookScrollProps["screenImage"];
}) {
  return (
    <div className="relative [perspective:800px]">
      ...
      >
        ...
        >
          <span className="text-white">{/* <MacbookLogo /> */}</span>
        </div>
      </div>
      <motion.div
        style={{
      ...
      >
        ...
        {screenImage ? (
          ...
          <div className="absolute inset-0 flex h-full w-full items-center justify-center rounded-lg bg-gradient-to-br from-primary/20 to-secondary/20">
