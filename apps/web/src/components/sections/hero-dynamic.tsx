...
export function HeroDynamic({
  ...
  return (
    ...
    >
      ...
      <HeroFloatingDecoration position="top-right" size={100} opacity={0.12} />
      <HeroFloatingDecoration position="left" size={70} opacity={0.1} />
      <HeroFloatingDecoration position="bottom-left" size={90} opacity={0.15} />
        ...
        <div className="grid lg:grid-cols-12 gap-6 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-5 relative">
            ...
            >
              {/* Main Screenshot */}
              {image && (
                <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-border/50 ring-1 ring-primary/10"
                  style={{
                    boxShadow: '0 20px 40px rgba(0,0,0,0.1), 0 0 60px rgba(var(--primary-rgb, 66, 153, 66), 0.15)'
                  }}>
                  <SanityImage
                    image={image}
              ...
              <HeroFloatingCard position="bottom-right" delay={1200}>
                <div className="w-60 space-y-2">
                  <div className="text-sm font-semibold">Event Notification</div>
                  <div className="text-xs text-muted-foreground">
