...
const DEFAULT_BUTTONS: SanityButtonProps[] = [
  {
    _key: "default-open-app",
    _type: "button",
    text: "Open Flyball Hub",
    variant: "default",
    href: "https://app.flyballhub.com",
    openInNewTab: true,
  },
  {
    _key: "default-find-team",
    _type: "button",
    text: "Find a team",
    variant: "outline",
    href: "/find-a-team",
    ...
    <div className="relative aspect-[9/19.5] bg-gradient-to-b from-emerald-900 via-emerald-950 to-gray-950 overflow-hidden">
      ...
      <div className="pt-14 px-5">
        ...
        <div className="mt-4 flex gap-2">
          {["Dogs", "Training", "Events"].map((label) => (
            <div
              key={label}
  ...
  const badge = (
    ...
    >
      ...
      >
        <path
          fill="#a6a6a6"
          d="M130.2 40H4.7A4.7 4.7 0 0 1 0 35.3V4.7A4.7 4.7 0 0 1 4.7 0h125.5a4.7 4.7 0 0 1 4.7 4.7v30.5a4.7 4.7 0 0 1-4.7 4.8z"
        />
      ...
      {isDisabled && comingSoon && (
        <span className="text-[10px] text-emerald-200/60 mt-1">
          Coming Soon
        </span>
      )}
    </span>
...
export function AppPromoBlock({
  ...
  const displaySocialProofText =
    socialProofText || DEFAULT_APP_PROMO.socialProofText;
  const displayPlatformNote = platformNote || DEFAULT_APP_PROMO.platformNote;
  const displayStarRating = starRating?.trim();
  const shouldShowStarRating = !!showStarRating && !!displayStarRating;
  ...
  const renderTitle = () => {
    const displayTitle = title || DEFAULT_APP_PROMO.title;
    const highlight = highlightedText || DEFAULT_APP_PROMO.highlightedText;
  ...
  return (
    <section ref={ref} className="py-8" aria-labelledby="app-promo-heading">
          ...
          <div className="relative z-10 px-6 py-12 md:px-10 md:py-16 lg:px-16 lg:py-20">
            <div className="grid gap-10 lg:grid-cols-2 lg:gap-12 xl:gap-20 items-center">
              ...
              <div className="max-w-xl">
                ...
                >
                  <span className="relative overflow-hidden px-4 py-1.5 text-xs font-bold tracking-widest uppercase text-emerald-900 bg-lime-400 rounded-full shadow-lg shadow-lime-400/25">
                    <span className="relative z-10">
                      {eyebrow || DEFAULT_APP_PROMO.eyebrow}
                    </span>
                    {/* Shine effect */}
                    <span
                      className={cn(
                ...
                >
                  {description || DEFAULT_APP_PROMO.description}
                </p>
                ...
                >
                  ...
                  {shouldShowStarRating && (
                    <div
                      ...
                      aria-label={`${displayStarRating} out of 5 stars rating`}
                    >
                      {starIcon}
                      {starIcon}
                      {starIcon}
