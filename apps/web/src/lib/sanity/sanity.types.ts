...
export type QueryBreedBySlugResult = null;
// Variable: queryBreedPaths
// Query: *[_type == "breed" && defined(slug.current)].slug.current
export type QueryBreedPathsResult = Array<never>;
...
export type QueryAllBreedsResult = Array<never>;
...
export type QueryBreedPageOGDataResult = null;
