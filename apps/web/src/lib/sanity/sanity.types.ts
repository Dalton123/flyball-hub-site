...
export type FeatureCardsScreenshot = {
...
export type AppPromo = {
  ...
  features?: Array<{
    title?: string;
    description?: string;
    icon?: "users" | "calendar" | "layoutGrid";
    _key: string;
  }>;
...
// Query: *[_type == "page" && defined(image)][0]{      image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  }  }.image
...
// Query: *[_type == "homePage" && _id == "homePage"][0]{    ...,    _id,    _type,    "slug": slug.current,    title,    description,    "seoImageUrl": seoImage.asset->url + "?w=1200&h=630&fit=fill&bg=fbf2d6&fm=jpg&q=85&v=20260607",      pageBuilder[]{    ...,    _type,      _type == "appPromo" => {    _type,    _key,    "eyebrow": select(      useGlobalDefaults == false && defined(eyebrow) => eyebrow,      defined(*[_type == "settings"][0].appPromoDefaults.eyebrow) => *[_type == "settings"][0].appPromoDefaults.eyebrow,      null    ),    "title": select(      useGlobalDefaults == false && defined(title) => title,      defined(*[_type == "settings"][0].appPromoDefaults.title) => *[_type == "settings"][0].appPromoDefaults.title,      null    ),    "highlightedText": select(      useGlobalDefaults == false && defined(highlightedText) => highlightedText,      defined(*[_type == "settings"][0].appPromoDefaults.highlightedText) => *[_type == "settings"][0].appPromoDefaults.highlightedText,      null    ),    "description": select(      useGlobalDefaults == false && defined(description) => description,      defined(*[_type == "settings"][0].appPromoDefaults.description) => *[_type == "settings"][0].appPromoDefaults.description,      null    ),    "features": select(      useGlobalDefaults == false && count(features[]) > 0 => features[] {   _key,  title,  description,  icon },      count(*[_type == "settings"][0].appPromoDefaults.features[]) > 0 => *[_type == "settings"][0].appPromoDefaults.features[] {   _key,  title,  description,  icon },      null    ),    "socialProofText": select(      useGlobalDefaults == false && defined(socialProofText) => socialProofText,      defined(*[_type == "settings"][0].appPromoDefaults.socialProofText) => *[_type == "settings"][0].appPromoDefaults.socialProofText,      null    ),    "showStarRating": select(      useGlobalDefaults == false && defined(showStarRating) => showStarRating,      defined(*[_type == "settings"][0].appPromoDefaults.showStarRating) => *[_type == "settings"][0].appPromoDefaults.showStarRating,      false    ),    "starRating": select(      useGlobalDefaults == false && defined(starRating) => starRating,      defined(*[_type == "settings"][0].appPromoDefaults.starRating) => *[_type == "settings"][0].appPromoDefaults.starRating,      null    ),    "buttons": select(      useGlobalDefaults == false && count(buttons[]) > 0 => buttons[] {   text,  variant,  _key,  _type,  "openInNewTab": url.openInNewTab,  "href": select(    url.type == "internal" => url.internal->slug.current,    url.type == "external" => url.external,    url.href  ) },      count(*[_type == "settings"][0].appPromoDefaults.buttons[]) > 0 => *[_type == "settings"][0].appPromoDefaults.buttons[] {   text,  variant,  _key,  _type,  "openInNewTab": url.openInNewTab,  "href": select(    url.type == "internal" => url.internal->slug.current,    url.type == "external" => url.external,    url.href  ) },      null    ),    "platformNote": select(      useGlobalDefaults == false && defined(platformNote) => platformNote,      defined(*[_type == "settings"][0].appPromoDefaults.platformNote) => *[_type == "settings"][0].appPromoDefaults.platformNote,      null    ),    "phoneScreenshot": select(      useGlobalDefaults == false && defined(phoneScreenshot.asset) => phoneScreenshot {   "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  } },      defined(*[_type == "settings"][0].appPromoDefaults.phoneScreenshot.asset) => *[_type == "settings"][0].appPromoDefaults.phoneScreenshot {   "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  } },      null    ),    "showAppStoreButtons": select(      useGlobalDefaults == false && defined(showAppStoreButtons) => showAppStoreButtons,      defined(*[_type == "settings"][0].appPromoDefaults.showAppStoreButtons) => *[_type == "settings"][0].appPromoDefaults.showAppStoreButtons,      false    ),    "googlePlayUrl": select(      useGlobalDefaults == false && defined(googlePlayUrl) => googlePlayUrl,      defined(*[_type == "settings"][0].appPromoDefaults.googlePlayUrl) => *[_type == "settings"][0].appPromoDefaults.googlePlayUrl,      null    ),    "appStoreUrl": select(      useGlobalDefaults == false && defined(appStoreUrl) => appStoreUrl,      defined(*[_type == "settings"][0].appPromoDefaults.appStoreUrl) => *[_type == "settings"][0].appPromoDefaults.appStoreUrl,      null    ),    "appStoreComingSoon": select(      useGlobalDefaults == false && defined(appStoreComingSoon) => appStoreComingSoon,      false    )  },      _type == "cta" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },      buttons[]{    text,    variant,    _key,    _type,    "openInNewTab": url.openInNewTab,    "href": select(      url.type == "internal" => url.internal->slug.current,      url.type == "external" => url.external,      url.href    ),  },  },      _type == "hero" => {    ...,      image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  },      buttons[]{    text,    variant,    _key,    _type,    "openInNewTab": url.openInNewTab,    "href": select(      url.type == "internal" => url.internal->slug.current,      url.type == "external" => url.external,      url.href    ),  },      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },    variant,    "stats": array::compact(stats[]{      _key,      value,      label    })  },      _type == "faqAccordion" => {    ...,      "faqs": array::compact(faqs[]->{    title,    _id,    _type,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  }  }),    link{      ...,      "openInNewTab": url.openInNewTab,      "href": select(        url.type == "internal" => url.internal->slug.current,        url.type == "external" => url.external,        url.href      )    }  },      _type == "featureCardsIcon" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },    "cards": array::compact(cards[]{      ...,        richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },    })  },      _type == "featureCardsScreenshot" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },    "cards": array::compact(cards[]{      ...,      _key,      title,      description,      "screenshot": screenshot {          "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }      },      "openInNewTab": url.openInNewTab,      "href": select(        url.type == "internal" => url.internal->slug.current,        url.type == "external" => url.external,        url.href      )    })  },      _type == "subscribeNewsletter" => {    ...,    "subTitle": subTitle[]{      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    "helperText": helperText[]{      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    }  },      _type == "imageLinkCards" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },      buttons[]{    text,    variant,    _key,    _type,    "openInNewTab": url.openInNewTab,    "href": select(      url.type == "internal" => url.internal->slug.current,      url.type == "external" => url.external,      url.href    ),  },    "cards": array::compact(cards[]{      ...,      "openInNewTab": url.openInNewTab,      "href": select(        url.type == "internal" => url.internal->slug.current,        url.type == "external" => url.external,        url.href      ),        image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  },    })  },      _type == "textBlock" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  }  },      _type == "testimonials" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },    "testimonials": array::compact(testimonials[]{      ...,      _key,      quote,      authorName,      authorRole,      rating,      "authorImage": authorImage {          "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }      }    })  },      _type == "logoCloud" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },    "logos": array::compact(logos[]{      ...,      _key,      name,      url,      "logo": logo {          "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }      }    })  },      _type == "statsSection" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },    variant,    "stats": array::compact(stats[]{      ...,      _key,      value,      label,      description    })  },      _type == "macbookScroll" => {    ...,    eyebrow,    title,    description,    "screenImage": screenImage {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }    },    showGradient  },      _type == "videoSection" => {    ...,    eyebrow,    title,    description,    videoUrl,    "posterImage": posterImage {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }    }  },      _type == "latestPosts" => {    ...,    eyebrow,    title,    description,    postsCount,    showViewAll,    "posts": *[_type == "blog" && seoHideFromLists != true && defined(publishedAt) && publishedAt <= now()] | order(publishedAt desc)[0..6]{        _type,  _id,  title,  description,  "slug":slug.current,  orderRank,    image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  },  publishedAt,    authors[0]->{    _id,    name,    position,      image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  }  }    }  },      _type == "teamFinder" => {    _type,    _key,    eyebrow,    title,    description,    searchPlaceholder,    noResultsMessage  },      _type == "teamFinderTeaser" => {    _type,    _key,    eyebrow,    title,    description,    searchPlaceholder,    showStats,    ctaText  }  }  }
...
// Query: *[_type == "page" && slug.current == $slug][0]{    ...,    "slug": slug.current,      pageBuilder[]{    ...,    _type,      _type == "appPromo" => {    _type,    _key,    "eyebrow": select(      useGlobalDefaults == false && defined(eyebrow) => eyebrow,      defined(*[_type == "settings"][0].appPromoDefaults.eyebrow) => *[_type == "settings"][0].appPromoDefaults.eyebrow,      null    ),    "title": select(      useGlobalDefaults == false && defined(title) => title,      defined(*[_type == "settings"][0].appPromoDefaults.title) => *[_type == "settings"][0].appPromoDefaults.title,      null    ),    "highlightedText": select(      useGlobalDefaults == false && defined(highlightedText) => highlightedText,      defined(*[_type == "settings"][0].appPromoDefaults.highlightedText) => *[_type == "settings"][0].appPromoDefaults.highlightedText,      null    ),    "description": select(      useGlobalDefaults == false && defined(description) => description,      defined(*[_type == "settings"][0].appPromoDefaults.description) => *[_type == "settings"][0].appPromoDefaults.description,      null    ),    "features": select(      useGlobalDefaults == false && count(features[]) > 0 => features[] {   _key,  title,  description,  icon },      count(*[_type == "settings"][0].appPromoDefaults.features[]) > 0 => *[_type == "settings"][0].appPromoDefaults.features[] {   _key,  title,  description,  icon },      null    ),    "socialProofText": select(      useGlobalDefaults == false && defined(socialProofText) => socialProofText,      defined(*[_type == "settings"][0].appPromoDefaults.socialProofText) => *[_type == "settings"][0].appPromoDefaults.socialProofText,      null    ),    "showStarRating": select(      useGlobalDefaults == false && defined(showStarRating) => showStarRating,      defined(*[_type == "settings"][0].appPromoDefaults.showStarRating) => *[_type == "settings"][0].appPromoDefaults.showStarRating,      false    ),    "starRating": select(      useGlobalDefaults == false && defined(starRating) => starRating,      defined(*[_type == "settings"][0].appPromoDefaults.starRating) => *[_type == "settings"][0].appPromoDefaults.starRating,      null    ),    "buttons": select(      useGlobalDefaults == false && count(buttons[]) > 0 => buttons[] {   text,  variant,  _key,  _type,  "openInNewTab": url.openInNewTab,  "href": select(    url.type == "internal" => url.internal->slug.current,    url.type == "external" => url.external,    url.href  ) },      count(*[_type == "settings"][0].appPromoDefaults.buttons[]) > 0 => *[_type == "settings"][0].appPromoDefaults.buttons[] {   text,  variant,  _key,  _type,  "openInNewTab": url.openInNewTab,  "href": select(    url.type == "internal" => url.internal->slug.current,    url.type == "external" => url.external,    url.href  ) },      null    ),    "platformNote": select(      useGlobalDefaults == false && defined(platformNote) => platformNote,      defined(*[_type == "settings"][0].appPromoDefaults.platformNote) => *[_type == "settings"][0].appPromoDefaults.platformNote,      null    ),    "phoneScreenshot": select(      useGlobalDefaults == false && defined(phoneScreenshot.asset) => phoneScreenshot {   "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  } },      defined(*[_type == "settings"][0].appPromoDefaults.phoneScreenshot.asset) => *[_type == "settings"][0].appPromoDefaults.phoneScreenshot {   "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  } },      null    ),    "showAppStoreButtons": select(      useGlobalDefaults == false && defined(showAppStoreButtons) => showAppStoreButtons,      defined(*[_type == "settings"][0].appPromoDefaults.showAppStoreButtons) => *[_type == "settings"][0].appPromoDefaults.showAppStoreButtons,      false    ),    "googlePlayUrl": select(      useGlobalDefaults == false && defined(googlePlayUrl) => googlePlayUrl,      defined(*[_type == "settings"][0].appPromoDefaults.googlePlayUrl) => *[_type == "settings"][0].appPromoDefaults.googlePlayUrl,      null    ),    "appStoreUrl": select(      useGlobalDefaults == false && defined(appStoreUrl) => appStoreUrl,      defined(*[_type == "settings"][0].appPromoDefaults.appStoreUrl) => *[_type == "settings"][0].appPromoDefaults.appStoreUrl,      null    ),    "appStoreComingSoon": select(      useGlobalDefaults == false && defined(appStoreComingSoon) => appStoreComingSoon,      false    )  },      _type == "cta" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },      buttons[]{    text,    variant,    _key,    _type,    "openInNewTab": url.openInNewTab,    "href": select(      url.type == "internal" => url.internal->slug.current,      url.type == "external" => url.external,      url.href    ),  },  },      _type == "hero" => {    ...,      image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  },      buttons[]{    text,    variant,    _key,    _type,    "openInNewTab": url.openInNewTab,    "href": select(      url.type == "internal" => url.internal->slug.current,      url.type == "external" => url.external,      url.href    ),  },      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },    variant,    "stats": array::compact(stats[]{      _key,      value,      label    })  },      _type == "faqAccordion" => {    ...,      "faqs": array::compact(faqs[]->{    title,    _id,    _type,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  }  }),    link{      ...,      "openInNewTab": url.openInNewTab,      "href": select(        url.type == "internal" => url.internal->slug.current,        url.type == "external" => url.external,        url.href      )    }  },      _type == "featureCardsIcon" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },    "cards": array::compact(cards[]{      ...,        richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },    })  },      _type == "featureCardsScreenshot" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },    "cards": array::compact(cards[]{      ...,      _key,      title,      description,      "screenshot": screenshot {          "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }      },      "openInNewTab": url.openInNewTab,      "href": select(        url.type == "internal" => url.internal->slug.current,        url.type == "external" => url.external,        url.href      )    })  },      _type == "subscribeNewsletter" => {    ...,    "subTitle": subTitle[]{      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    "helperText": helperText[]{      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    }  },      _type == "imageLinkCards" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },      buttons[]{    text,    variant,    _key,    _type,    "openInNewTab": url.openInNewTab,    "href": select(      url.type == "internal" => url.internal->slug.current,      url.type == "external" => url.external,      url.href    ),  },    "cards": array::compact(cards[]{      ...,      "openInNewTab": url.openInNewTab,      "href": select(        url.type == "internal" => url.internal->slug.current,        url.type == "external" => url.external,        url.href      ),        image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  },    })  },      _type == "textBlock" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  }  },      _type == "testimonials" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },    "testimonials": array::compact(testimonials[]{      ...,      _key,      quote,      authorName,      authorRole,      rating,      "authorImage": authorImage {          "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }      }    })  },      _type == "logoCloud" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },    "logos": array::compact(logos[]{      ...,      _key,      name,      url,      "logo": logo {          "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }      }    })  },      _type == "statsSection" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },    variant,    "stats": array::compact(stats[]{      ...,      _key,      value,      label,      description    })  },      _type == "macbookScroll" => {    ...,    eyebrow,    title,    description,    "screenImage": screenImage {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }    },    showGradient  },      _type == "videoSection" => {    ...,    eyebrow,    title,    description,    videoUrl,    "posterImage": posterImage {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }    }  },      _type == "latestPosts" => {    ...,    eyebrow,    title,    description,    postsCount,    showViewAll,    "posts": *[_type == "blog" && seoHideFromLists != true && defined(publishedAt) && publishedAt <= now()] | order(publishedAt desc)[0..6]{        _type,  _id,  title,  description,  "slug":slug.current,  orderRank,    image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  },  publishedAt,    authors[0]->{    _id,    name,    position,      image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  }  }    }  },      _type == "teamFinder" => {    _type,    _key,    eyebrow,    title,    description,    searchPlaceholder,    noResultsMessage  },      _type == "teamFinderTeaser" => {    _type,    _key,    eyebrow,    title,    description,    searchPlaceholder,    showStats,    ctaText  }  }  }
...
// Query: *[_type == "blogIndex"][0]{    ...,    _id,    _type,    title,    description,    "displayFeaturedBlogs" : displayFeaturedBlogs == "yes",    "featuredBlogsCount" : featuredBlogsCount,      pageBuilder[]{    ...,    _type,      _type == "appPromo" => {    _type,    _key,    "eyebrow": select(      useGlobalDefaults == false && defined(eyebrow) => eyebrow,      defined(*[_type == "settings"][0].appPromoDefaults.eyebrow) => *[_type == "settings"][0].appPromoDefaults.eyebrow,      null    ),    "title": select(      useGlobalDefaults == false && defined(title) => title,      defined(*[_type == "settings"][0].appPromoDefaults.title) => *[_type == "settings"][0].appPromoDefaults.title,      null    ),    "highlightedText": select(      useGlobalDefaults == false && defined(highlightedText) => highlightedText,      defined(*[_type == "settings"][0].appPromoDefaults.highlightedText) => *[_type == "settings"][0].appPromoDefaults.highlightedText,      null    ),    "description": select(      useGlobalDefaults == false && defined(description) => description,      defined(*[_type == "settings"][0].appPromoDefaults.description) => *[_type == "settings"][0].appPromoDefaults.description,      null    ),    "features": select(      useGlobalDefaults == false && count(features[]) > 0 => features[] {   _key,  title,  description,  icon },      count(*[_type == "settings"][0].appPromoDefaults.features[]) > 0 => *[_type == "settings"][0].appPromoDefaults.features[] {   _key,  title,  description,  icon },      null    ),    "socialProofText": select(      useGlobalDefaults == false && defined(socialProofText) => socialProofText,      defined(*[_type == "settings"][0].appPromoDefaults.socialProofText) => *[_type == "settings"][0].appPromoDefaults.socialProofText,      null    ),    "showStarRating": select(      useGlobalDefaults == false && defined(showStarRating) => showStarRating,      defined(*[_type == "settings"][0].appPromoDefaults.showStarRating) => *[_type == "settings"][0].appPromoDefaults.showStarRating,      false    ),    "starRating": select(      useGlobalDefaults == false && defined(starRating) => starRating,      defined(*[_type == "settings"][0].appPromoDefaults.starRating) => *[_type == "settings"][0].appPromoDefaults.starRating,      null    ),    "buttons": select(      useGlobalDefaults == false && count(buttons[]) > 0 => buttons[] {   text,  variant,  _key,  _type,  "openInNewTab": url.openInNewTab,  "href": select(    url.type == "internal" => url.internal->slug.current,    url.type == "external" => url.external,    url.href  ) },      count(*[_type == "settings"][0].appPromoDefaults.buttons[]) > 0 => *[_type == "settings"][0].appPromoDefaults.buttons[] {   text,  variant,  _key,  _type,  "openInNewTab": url.openInNewTab,  "href": select(    url.type == "internal" => url.internal->slug.current,    url.type == "external" => url.external,    url.href  ) },      null    ),    "platformNote": select(      useGlobalDefaults == false && defined(platformNote) => platformNote,      defined(*[_type == "settings"][0].appPromoDefaults.platformNote) => *[_type == "settings"][0].appPromoDefaults.platformNote,      null    ),    "phoneScreenshot": select(      useGlobalDefaults == false && defined(phoneScreenshot.asset) => phoneScreenshot {   "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  } },      defined(*[_type == "settings"][0].appPromoDefaults.phoneScreenshot.asset) => *[_type == "settings"][0].appPromoDefaults.phoneScreenshot {   "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  } },      null    ),    "showAppStoreButtons": select(      useGlobalDefaults == false && defined(showAppStoreButtons) => showAppStoreButtons,      defined(*[_type == "settings"][0].appPromoDefaults.showAppStoreButtons) => *[_type == "settings"][0].appPromoDefaults.showAppStoreButtons,      false    ),    "googlePlayUrl": select(      useGlobalDefaults == false && defined(googlePlayUrl) => googlePlayUrl,      defined(*[_type == "settings"][0].appPromoDefaults.googlePlayUrl) => *[_type == "settings"][0].appPromoDefaults.googlePlayUrl,      null    ),    "appStoreUrl": select(      useGlobalDefaults == false && defined(appStoreUrl) => appStoreUrl,      defined(*[_type == "settings"][0].appPromoDefaults.appStoreUrl) => *[_type == "settings"][0].appPromoDefaults.appStoreUrl,      null    ),    "appStoreComingSoon": select(      useGlobalDefaults == false && defined(appStoreComingSoon) => appStoreComingSoon,      false    )  },      _type == "cta" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },      buttons[]{    text,    variant,    _key,    _type,    "openInNewTab": url.openInNewTab,    "href": select(      url.type == "internal" => url.internal->slug.current,      url.type == "external" => url.external,      url.href    ),  },  },      _type == "hero" => {    ...,      image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  },      buttons[]{    text,    variant,    _key,    _type,    "openInNewTab": url.openInNewTab,    "href": select(      url.type == "internal" => url.internal->slug.current,      url.type == "external" => url.external,      url.href    ),  },      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },    variant,    "stats": array::compact(stats[]{      _key,      value,      label    })  },      _type == "faqAccordion" => {    ...,      "faqs": array::compact(faqs[]->{    title,    _id,    _type,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  }  }),    link{      ...,      "openInNewTab": url.openInNewTab,      "href": select(        url.type == "internal" => url.internal->slug.current,        url.type == "external" => url.external,        url.href      )    }  },      _type == "featureCardsIcon" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },    "cards": array::compact(cards[]{      ...,        richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },    })  },      _type == "featureCardsScreenshot" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },    "cards": array::compact(cards[]{      ...,      _key,      title,      description,      "screenshot": screenshot {          "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }      },      "openInNewTab": url.openInNewTab,      "href": select(        url.type == "internal" => url.internal->slug.current,        url.type == "external" => url.external,        url.href      )    })  },      _type == "subscribeNewsletter" => {    ...,    "subTitle": subTitle[]{      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    "helperText": helperText[]{      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    }  },      _type == "imageLinkCards" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },      buttons[]{    text,    variant,    _key,    _type,    "openInNewTab": url.openInNewTab,    "href": select(      url.type == "internal" => url.internal->slug.current,      url.type == "external" => url.external,      url.href    ),  },    "cards": array::compact(cards[]{      ...,      "openInNewTab": url.openInNewTab,      "href": select(        url.type == "internal" => url.internal->slug.current,        url.type == "external" => url.external,        url.href      ),        image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  },    })  },      _type == "textBlock" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  }  },      _type == "testimonials" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },    "testimonials": array::compact(testimonials[]{      ...,      _key,      quote,      authorName,      authorRole,      rating,      "authorImage": authorImage {          "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }      }    })  },      _type == "logoCloud" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },    "logos": array::compact(logos[]{      ...,      _key,      name,      url,      "logo": logo {          "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }      }    })  },      _type == "statsSection" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },    variant,    "stats": array::compact(stats[]{      ...,      _key,      value,      label,      description    })  },      _type == "macbookScroll" => {    ...,    eyebrow,    title,    description,    "screenImage": screenImage {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }    },    showGradient  },      _type == "videoSection" => {    ...,    eyebrow,    title,    description,    videoUrl,    "posterImage": posterImage {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }    }  },      _type == "latestPosts" => {    ...,    eyebrow,    title,    description,    postsCount,    showViewAll,    "posts": *[_type == "blog" && seoHideFromLists != true && defined(publishedAt) && publishedAt <= now()] | order(publishedAt desc)[0..6]{        _type,  _id,  title,  description,  "slug":slug.current,  orderRank,    image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  },  publishedAt,    authors[0]->{    _id,    name,    position,      image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  }  }    }  },      _type == "teamFinder" => {    _type,    _key,    eyebrow,    title,    description,    searchPlaceholder,    noResultsMessage  },      _type == "teamFinderTeaser" => {    _type,    _key,    eyebrow,    title,    description,    searchPlaceholder,    showStats,    ctaText  }  },    "slug": slug.current,    "blogs": *[_type == "blog" && seoHideFromLists != true && defined(publishedAt) && publishedAt <= now()] | order(publishedAt desc){        _type,  _id,  title,  description,  "slug":slug.current,  orderRank,    image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  },  publishedAt,    authors[0]->{    _id,    name,    position,      image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  }  }    }  }
...
// Query: *[_type == "blog" && slug.current == $slug && defined(publishedAt) && publishedAt <= now()][0]{    ...,    "slug": slug.current,    "productList": productList[]{      name,      position,      "url": url    },    "howToSteps": howToSteps[]{      name,      text,      "url": url    },      authors[0]->{    _id,    name,    position,      image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  }  },      image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  },      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },      pageBuilder[]{    ...,    _type,      _type == "appPromo" => {    _type,    _key,    "eyebrow": select(      useGlobalDefaults == false && defined(eyebrow) => eyebrow,      defined(*[_type == "settings"][0].appPromoDefaults.eyebrow) => *[_type == "settings"][0].appPromoDefaults.eyebrow,      null    ),    "title": select(      useGlobalDefaults == false && defined(title) => title,      defined(*[_type == "settings"][0].appPromoDefaults.title) => *[_type == "settings"][0].appPromoDefaults.title,      null    ),    "highlightedText": select(      useGlobalDefaults == false && defined(highlightedText) => highlightedText,      defined(*[_type == "settings"][0].appPromoDefaults.highlightedText) => *[_type == "settings"][0].appPromoDefaults.highlightedText,      null    ),    "description": select(      useGlobalDefaults == false && defined(description) => description,      defined(*[_type == "settings"][0].appPromoDefaults.description) => *[_type == "settings"][0].appPromoDefaults.description,      null    ),    "features": select(      useGlobalDefaults == false && count(features[]) > 0 => features[] {   _key,  title,  description,  icon },      count(*[_type == "settings"][0].appPromoDefaults.features[]) > 0 => *[_type == "settings"][0].appPromoDefaults.features[] {   _key,  title,  description,  icon },      null    ),    "socialProofText": select(      useGlobalDefaults == false && defined(socialProofText) => socialProofText,      defined(*[_type == "settings"][0].appPromoDefaults.socialProofText) => *[_type == "settings"][0].appPromoDefaults.socialProofText,      null    ),    "showStarRating": select(      useGlobalDefaults == false && defined(showStarRating) => showStarRating,      defined(*[_type == "settings"][0].appPromoDefaults.showStarRating) => *[_type == "settings"][0].appPromoDefaults.showStarRating,      false    ),    "starRating": select(      useGlobalDefaults == false && defined(starRating) => starRating,      defined(*[_type == "settings"][0].appPromoDefaults.starRating) => *[_type == "settings"][0].appPromoDefaults.starRating,      null    ),    "buttons": select(      useGlobalDefaults == false && count(buttons[]) > 0 => buttons[] {   text,  variant,  _key,  _type,  "openInNewTab": url.openInNewTab,  "href": select(    url.type == "internal" => url.internal->slug.current,    url.type == "external" => url.external,    url.href  ) },      count(*[_type == "settings"][0].appPromoDefaults.buttons[]) > 0 => *[_type == "settings"][0].appPromoDefaults.buttons[] {   text,  variant,  _key,  _type,  "openInNewTab": url.openInNewTab,  "href": select(    url.type == "internal" => url.internal->slug.current,    url.type == "external" => url.external,    url.href  ) },      null    ),    "platformNote": select(      useGlobalDefaults == false && defined(platformNote) => platformNote,      defined(*[_type == "settings"][0].appPromoDefaults.platformNote) => *[_type == "settings"][0].appPromoDefaults.platformNote,      null    ),    "phoneScreenshot": select(      useGlobalDefaults == false && defined(phoneScreenshot.asset) => phoneScreenshot {   "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  } },      defined(*[_type == "settings"][0].appPromoDefaults.phoneScreenshot.asset) => *[_type == "settings"][0].appPromoDefaults.phoneScreenshot {   "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  } },      null    ),    "showAppStoreButtons": select(      useGlobalDefaults == false && defined(showAppStoreButtons) => showAppStoreButtons,      defined(*[_type == "settings"][0].appPromoDefaults.showAppStoreButtons) => *[_type == "settings"][0].appPromoDefaults.showAppStoreButtons,      false    ),    "googlePlayUrl": select(      useGlobalDefaults == false && defined(googlePlayUrl) => googlePlayUrl,      defined(*[_type == "settings"][0].appPromoDefaults.googlePlayUrl) => *[_type == "settings"][0].appPromoDefaults.googlePlayUrl,      null    ),    "appStoreUrl": select(      useGlobalDefaults == false && defined(appStoreUrl) => appStoreUrl,      defined(*[_type == "settings"][0].appPromoDefaults.appStoreUrl) => *[_type == "settings"][0].appPromoDefaults.appStoreUrl,      null    ),    "appStoreComingSoon": select(      useGlobalDefaults == false && defined(appStoreComingSoon) => appStoreComingSoon,      false    )  },      _type == "cta" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },      buttons[]{    text,    variant,    _key,    _type,    "openInNewTab": url.openInNewTab,    "href": select(      url.type == "internal" => url.internal->slug.current,      url.type == "external" => url.external,      url.href    ),  },  },      _type == "hero" => {    ...,      image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  },      buttons[]{    text,    variant,    _key,    _type,    "openInNewTab": url.openInNewTab,    "href": select(      url.type == "internal" => url.internal->slug.current,      url.type == "external" => url.external,      url.href    ),  },      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },    variant,    "stats": array::compact(stats[]{      _key,      value,      label    })  },      _type == "faqAccordion" => {    ...,      "faqs": array::compact(faqs[]->{    title,    _id,    _type,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  }  }),    link{      ...,      "openInNewTab": url.openInNewTab,      "href": select(        url.type == "internal" => url.internal->slug.current,        url.type == "external" => url.external,        url.href      )    }  },      _type == "featureCardsIcon" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },    "cards": array::compact(cards[]{      ...,        richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },    })  },      _type == "featureCardsScreenshot" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },    "cards": array::compact(cards[]{      ...,      _key,      title,      description,      "screenshot": screenshot {          "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }      },      "openInNewTab": url.openInNewTab,      "href": select(        url.type == "internal" => url.internal->slug.current,        url.type == "external" => url.external,        url.href      )    })  },      _type == "subscribeNewsletter" => {    ...,    "subTitle": subTitle[]{      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    "helperText": helperText[]{      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    }  },      _type == "imageLinkCards" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },      buttons[]{    text,    variant,    _key,    _type,    "openInNewTab": url.openInNewTab,    "href": select(      url.type == "internal" => url.internal->slug.current,      url.type == "external" => url.external,      url.href    ),  },    "cards": array::compact(cards[]{      ...,      "openInNewTab": url.openInNewTab,      "href": select(        url.type == "internal" => url.internal->slug.current,        url.type == "external" => url.external,        url.href      ),        image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  },    })  },      _type == "textBlock" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  }  },      _type == "testimonials" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },    "testimonials": array::compact(testimonials[]{      ...,      _key,      quote,      authorName,      authorRole,      rating,      "authorImage": authorImage {          "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }      }    })  },      _type == "logoCloud" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },    "logos": array::compact(logos[]{      ...,      _key,      name,      url,      "logo": logo {          "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }      }    })  },      _type == "statsSection" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },    variant,    "stats": array::compact(stats[]{      ...,      _key,      value,      label,      description    })  },      _type == "macbookScroll" => {    ...,    eyebrow,    title,    description,    "screenImage": screenImage {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }    },    showGradient  },      _type == "videoSection" => {    ...,    eyebrow,    title,    description,    videoUrl,    "posterImage": posterImage {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }    }  },      _type == "latestPosts" => {    ...,    eyebrow,    title,    description,    postsCount,    showViewAll,    "posts": *[_type == "blog" && seoHideFromLists != true && defined(publishedAt) && publishedAt <= now()] | order(publishedAt desc)[0..6]{        _type,  _id,  title,  description,  "slug":slug.current,  orderRank,    image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  },  publishedAt,    authors[0]->{    _id,    name,    position,      image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  }  }    }  },      _type == "teamFinder" => {    _type,    _key,    eyebrow,    title,    description,    searchPlaceholder,    noResultsMessage  },      _type == "teamFinderTeaser" => {    _type,    _key,    eyebrow,    title,    description,    searchPlaceholder,    showStats,    ctaText  }  }  }
...
// Query: *[_type == "blog" && defined(slug.current) && defined(publishedAt) && publishedAt <= now()].slug.current
export type QueryBlogPathsResult = Array<string>;
// Variable: queryBreedBySlug
// Query: *[_type == "breed" && slug.current == $slug][0]{    ...,    _id,    _type,    name,    "slug": slug.current,    verdict,    verdictRating,      image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  },    stats,    pros,    cons,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  }  }
export type QueryBreedBySlugResult = {
  _id: string;
  _type: "breed";
  _createdAt: string;
  _updatedAt: string;
...
// Variable: queryBreedPaths
// Query: *[_type == "breed" && defined(slug.current)].slug.current
export type QueryBreedPathsResult = Array<string>;
// Variable: queryAllBreeds
// Query: *[_type == "breed" && seoHideFromLists != true] | order(verdictRating desc, name asc){      _id,  _type,  name,  "slug": slug.current,  verdict,  verdictRating,    image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  },  stats  }
export type QueryAllBreedsResult = Array<{
  _id: string;
  _type: "breed";
  name: string;
  slug: string;
...
// Variable: queryBreedIndexPageData
// Query: *[_type == "breedIndex"][0]{    ...,    _id,    _type,    title,    description,    "slug": slug.current,      pageBuilder[]{    ...,    _type,      _type == "appPromo" => {    _type,    _key,    "eyebrow": select(      useGlobalDefaults == false && defined(eyebrow) => eyebrow,      defined(*[_type == "settings"][0].appPromoDefaults.eyebrow) => *[_type == "settings"][0].appPromoDefaults.eyebrow,      null    ),    "title": select(      useGlobalDefaults == false && defined(title) => title,      defined(*[_type == "settings"][0].appPromoDefaults.title) => *[_type == "settings"][0].appPromoDefaults.title,      null    ),    "highlightedText": select(      useGlobalDefaults == false && defined(highlightedText) => highlightedText,      defined(*[_type == "settings"][0].appPromoDefaults.highlightedText) => *[_type == "settings"][0].appPromoDefaults.highlightedText,      null    ),    "description": select(      useGlobalDefaults == false && defined(description) => description,      defined(*[_type == "settings"][0].appPromoDefaults.description) => *[_type == "settings"][0].appPromoDefaults.description,      null    ),    "features": select(      useGlobalDefaults == false && count(features[]) > 0 => features[] {   _key,  title,  description,  icon },      count(*[_type == "settings"][0].appPromoDefaults.features[]) > 0 => *[_type == "settings"][0].appPromoDefaults.features[] {   _key,  title,  description,  icon },      null    ),    "socialProofText": select(      useGlobalDefaults == false && defined(socialProofText) => socialProofText,      defined(*[_type == "settings"][0].appPromoDefaults.socialProofText) => *[_type == "settings"][0].appPromoDefaults.socialProofText,      null    ),    "showStarRating": select(      useGlobalDefaults == false && defined(showStarRating) => showStarRating,      defined(*[_type == "settings"][0].appPromoDefaults.showStarRating) => *[_type == "settings"][0].appPromoDefaults.showStarRating,      false    ),    "starRating": select(      useGlobalDefaults == false && defined(starRating) => starRating,      defined(*[_type == "settings"][0].appPromoDefaults.starRating) => *[_type == "settings"][0].appPromoDefaults.starRating,      null    ),    "buttons": select(      useGlobalDefaults == false && count(buttons[]) > 0 => buttons[] {   text,  variant,  _key,  _type,  "openInNewTab": url.openInNewTab,  "href": select(    url.type == "internal" => url.internal->slug.current,    url.type == "external" => url.external,    url.href  ) },      count(*[_type == "settings"][0].appPromoDefaults.buttons[]) > 0 => *[_type == "settings"][0].appPromoDefaults.buttons[] {   text,  variant,  _key,  _type,  "openInNewTab": url.openInNewTab,  "href": select(    url.type == "internal" => url.internal->slug.current,    url.type == "external" => url.external,    url.href  ) },      null    ),    "platformNote": select(      useGlobalDefaults == false && defined(platformNote) => platformNote,      defined(*[_type == "settings"][0].appPromoDefaults.platformNote) => *[_type == "settings"][0].appPromoDefaults.platformNote,      null    ),    "phoneScreenshot": select(      useGlobalDefaults == false && defined(phoneScreenshot.asset) => phoneScreenshot {   "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  } },      defined(*[_type == "settings"][0].appPromoDefaults.phoneScreenshot.asset) => *[_type == "settings"][0].appPromoDefaults.phoneScreenshot {   "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  } },      null    ),    "showAppStoreButtons": select(      useGlobalDefaults == false && defined(showAppStoreButtons) => showAppStoreButtons,      defined(*[_type == "settings"][0].appPromoDefaults.showAppStoreButtons) => *[_type == "settings"][0].appPromoDefaults.showAppStoreButtons,      false    ),    "googlePlayUrl": select(      useGlobalDefaults == false && defined(googlePlayUrl) => googlePlayUrl,      defined(*[_type == "settings"][0].appPromoDefaults.googlePlayUrl) => *[_type == "settings"][0].appPromoDefaults.googlePlayUrl,      null    ),    "appStoreUrl": select(      useGlobalDefaults == false && defined(appStoreUrl) => appStoreUrl,      defined(*[_type == "settings"][0].appPromoDefaults.appStoreUrl) => *[_type == "settings"][0].appPromoDefaults.appStoreUrl,      null    ),    "appStoreComingSoon": select(      useGlobalDefaults == false && defined(appStoreComingSoon) => appStoreComingSoon,      false    )  },      _type == "cta" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },      buttons[]{    text,    variant,    _key,    _type,    "openInNewTab": url.openInNewTab,    "href": select(      url.type == "internal" => url.internal->slug.current,      url.type == "external" => url.external,      url.href    ),  },  },      _type == "hero" => {    ...,      image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  },      buttons[]{    text,    variant,    _key,    _type,    "openInNewTab": url.openInNewTab,    "href": select(      url.type == "internal" => url.internal->slug.current,      url.type == "external" => url.external,      url.href    ),  },      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },    variant,    "stats": array::compact(stats[]{      _key,      value,      label    })  },      _type == "faqAccordion" => {    ...,      "faqs": array::compact(faqs[]->{    title,    _id,    _type,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  }  }),    link{      ...,      "openInNewTab": url.openInNewTab,      "href": select(        url.type == "internal" => url.internal->slug.current,        url.type == "external" => url.external,        url.href      )    }  },      _type == "featureCardsIcon" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },    "cards": array::compact(cards[]{      ...,        richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },    })  },      _type == "featureCardsScreenshot" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },    "cards": array::compact(cards[]{      ...,      _key,      title,      description,      "screenshot": screenshot {          "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }      },      "openInNewTab": url.openInNewTab,      "href": select(        url.type == "internal" => url.internal->slug.current,        url.type == "external" => url.external,        url.href      )    })  },      _type == "subscribeNewsletter" => {    ...,    "subTitle": subTitle[]{      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    "helperText": helperText[]{      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    }  },      _type == "imageLinkCards" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },      buttons[]{    text,    variant,    _key,    _type,    "openInNewTab": url.openInNewTab,    "href": select(      url.type == "internal" => url.internal->slug.current,      url.type == "external" => url.external,      url.href    ),  },    "cards": array::compact(cards[]{      ...,      "openInNewTab": url.openInNewTab,      "href": select(        url.type == "internal" => url.internal->slug.current,        url.type == "external" => url.external,        url.href      ),        image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  },    })  },      _type == "textBlock" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  }  },      _type == "testimonials" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },    "testimonials": array::compact(testimonials[]{      ...,      _key,      quote,      authorName,      authorRole,      rating,      "authorImage": authorImage {          "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }      }    })  },      _type == "logoCloud" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },    "logos": array::compact(logos[]{      ...,      _key,      name,      url,      "logo": logo {          "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }      }    })  },      _type == "statsSection" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "alt": alt,      "caption": caption    },    _type == "break" => {      _type,      _key,      style    },    _type == "blockquote" => {      _type,      _key,      quote,      attribution,      source    },    _type == "codeBlock" => {      _type,      _key,      code,      language,      filename,      highlightLines    },    _type == "table" => {      _type,      _key,      rows    }  },    variant,    "stats": array::compact(stats[]{      ...,      _key,      value,      label,      description    })  },      _type == "macbookScroll" => {    ...,    eyebrow,    title,    description,    "screenImage": screenImage {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }    },    showGradient  },      _type == "videoSection" => {    ...,    eyebrow,    title,    description,    videoUrl,    "posterImage": posterImage {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }    }  },      _type == "latestPosts" => {    ...,    eyebrow,    title,    description,    postsCount,    showViewAll,    "posts": *[_type == "blog" && seoHideFromLists != true && defined(publishedAt) && publishedAt <= now()] | order(publishedAt desc)[0..6]{        _type,  _id,  title,  description,  "slug":slug.current,  orderRank,    image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  },  publishedAt,    authors[0]->{    _id,    name,    position,      image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  }  }    }  },      _type == "teamFinder" => {    _type,    _key,    eyebrow,    title,    description,    searchPlaceholder,    noResultsMessage  },      _type == "teamFinderTeaser" => {    _type,    _key,    eyebrow,    title,    description,    searchPlaceholder,    showStats,    ctaText  }  },    "breeds": *[_type == "breed" && seoHideFromLists != true] | order(verdictRating desc, name asc){        _id,  _type,  name,  "slug": slug.current,  verdict,  verdictRating,    image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  },  stats    }  }
export type QueryBreedIndexPageDataResult = {
  _id: string;
  _type: "breedIndex";
  _createdAt: string;
  _updatedAt: string;
...
export type QueryGenericPageOGDataResult =
  ...
  | null;
// Variable: queryBreedPageOGData
// Query: *[_type == "breed" && _id == $id][0]{      _id,  _type,  "title": select(    defined(ogTitle) => ogTitle,    defined(seoTitle) => seoTitle,    title  ),  "description": select(    defined(ogDescription) => ogDescription,    defined(seoDescription) => seoDescription,    description  ),  "image": coalesce(    seoImage.asset->url + "?w=860&h=860&fit=crop&auto=format&q=86",    image.asset->url + "?w=860&h=860&fit=crop&auto=format&q=86"  ),  "dominantColor": image.asset->metadata.palette.dominant.background,  "seoImage": seoImage.asset->url + "?w=1200&h=630&fit=fill&bg=fbf2d6&fm=jpg&q=85",  "logo": *[_type == "settings"][0].logo.asset->url + "?w=120&h=120&fit=max&auto=format&q=90",  "date": coalesce(date, publishedAt, _createdAt),    "title": select(      defined(ogTitle) => ogTitle,      defined(seoTitle) => seoTitle,      name + " - Flyball Breed Guide"    )  }
export type QueryBreedPageOGDataResult = {
  _id: string;
  _type: "breed";
  title: string | null;
  description: string | null;
...
// Query: *[_type == "settings"][0]{    _id,    _type,    siteTitle,    logo {        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": alt,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }    },    siteDescription,    showFooter,    socialLinks{      linkedin,      facebook,      twitter,      instagram,      youtube    }  }
