...
```shell
cd apps/studio
npx sanity dataset import seed-data.tar.gz production
```

This command imports the provided seed data file into your Sanity dataset.
...
# Trigger redeploy for new blog post best-dog-treats-uk
